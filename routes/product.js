...
router.post('/add', fileUpload.single('productImg'), async(req, res) => {
...
router.get('/edit/:id', fileUpload.single('productImg'), async(req, res) => {
    const categories = await Category.find()
...
router.post('/edit/:id', fileUpload.single('productImg'), async(req, res) => {
...
router.get('/delete/:id', fileUpload.single('productImg'), async(req, res) => {
    const { productImg } = await Product.findById(req.params.id)
